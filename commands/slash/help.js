    ...
    collector.on("collect", async (iter) => {
      ...
      helpEmbed.addFields({
        ...
        value:
          ...
          "\n" +
          `[✨ Support Server](${client.config.supportServer}) | [BugReport](${client.config.Issues}) | [Source](https://github.com/SudhanPlayz/Discord-MusicBot/tree/v5) | [Mời](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
      });
      await iter.update({
        embeds: [helpEmbed],
        components: [getButtons(pageNo)],
